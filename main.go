...
//var urlUsage = map[string][]string{}
...
func walk(body []ast.Stmt) string{
	...
	//urlUsageMutex.RLock()
	//actions, ok := urlUsage[url]
	//urlUsageMutex.RUnlock()
	//if ok {
	//	if foundInList(actions, action) {
	//		return ""
	//	}
	//	urlUsageMutex.Lock()
	//	urlUsage[url] = append(actions, action)
	//} else {
	//	urlUsageMutex.Lock()
	//	urlUsage[url] = []string{action}
	//}
...
func main() {
	//defer func(){
	//	output, err := json.MarshalIndent(urlUsage, "", "\t")
	//	if err != nil {
	//		log.Printf("JSON Marshal Indent: %+v", err)
	//		return
	//	}
	//	fmt.Println(output)
	//}()
	...
	//	AllowErrors: false,
	//}
	//conf.Import("C:/Users/zhcheng/go/src/github.com/terraform-providers/terraform-provider-azurerm")
	//p, err := conf.Load()
	//if err != nil {
	//	fmt.Println(err)
	//}
